...
\\
\\
\textbf{\Large SEMESTER 3 -- ACADEMIC YEAR 2025--2026} \\
\end{tabular}
\end{center}
\vspace{0.5cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \item \Large \textbf{TRAINING PROGRAM: Teaching and Learning in English Programme}
\end{itemize}
\vspace{0.7cm}
\begin{itemize}
\renewcommand\labelitemi{--}
    ...
    \\ \Large \textbf{Mr. Lu Hoan Thien -- Cloud Workforce Development Programme Manager, AWS Vietnam}
    \item \Large \textbf{FACULTY SUPERVISOR / GRADER:}
    \\ \Large \textbf{Mr. Mai Duc Trung}
    \item \Large \textbf{STUDENT:}
    \\ \Large \textbf{FULL NAME: Tran Dang Khoa} \textbf{STUDENT ID: 23522590}
\end{itemize}
\vspace{0.5cm}
\begin{center}
