...
| Thứ | Công việc | Ngày |
| --- | --- | --- |
| 4 | - Lên kế hoạch dịch vụ AWS nào sẽ host từng thành phần của pipeline (lưu trữ corpus, vector index, orchestration, truy cập LLM) | 22/07/2026 |
| 5 | - **Thực hành:** upload corpus HotpotQA và embeddings đã tính sẵn lên S3 | 23/07/2026 |
| 6 | - **Thực hành:** đóng gói logic retrieval + suy luận đa bước vào một Lambda function / dịch vụ host trên SageMaker | 24/07/2026 |
| 2 | - **Thực hành:** expose pipeline qua một API endpoint và kiểm thử với các câu hỏi mẫu từ HotpotQA | 27/07/2026 |
| 3 | - Thêm CloudWatch logging và alarm cho pipeline (lỗi, độ trễ) <br> - Review tiến độ cùng mentor | 28/07/2026 |
