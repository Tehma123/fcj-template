...
| Thứ | Công việc | Ngày |
| --- | --- | --- |
| 4 | - Tìm hiểu tổng quan SageMaker: <br>&emsp; + Studio / notebook instance <br>&emsp; + Training job & model registry <br>&emsp; + Endpoint | 01/07/2026 |
| 5 | - **Thực hành:** khởi tạo một SageMaker notebook instance, load một model pretrained nhỏ và chạy inference | 02/07/2026 |
| 6 | - Tìm hiểu text embeddings: <br>&emsp; + Embedding là gì <br>&emsp; + Cosine similarity <br>&emsp; + Vì sao embeddings hỗ trợ semantic search | 03/07/2026 |
| 2 | - **Thực hành:** sinh embeddings cho một tập nhỏ đoạn văn bản trong SageMaker notebook và tính độ tương đồng giữa chúng | 06/07/2026 |
| 3 | - Khảo sát cấu trúc bộ dữ liệu HotpotQA (câu hỏi, supporting facts, đoạn văn bản ngữ cảnh) để chuẩn bị cho dự án RAG | 07/07/2026 |
